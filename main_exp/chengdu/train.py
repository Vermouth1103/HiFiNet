...
def train_hierarchy_construct(args):
    ...
    segment_features, segment_adj_matrix, transition_matrix, segment_dist_matrix, segment_sim_matrix = load_hierarchy_construct_data(config)
    ...
    for epoch in tqdm(range(config.epochs)):
        init_segment_features, high_freq_features, reconstructed_segment_features, updated_locality_features, updated_region_features, \
        ...
        loss_assignment = assignment_loss(segment2locality_assignments, locality2region_assignments)
